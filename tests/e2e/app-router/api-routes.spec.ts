...
test.describe("Route Handler Cache Headers (OpenNext compat)", () => {
  ...
  test.fixme("static GET route handler has s-maxage Cache-Control", async ({ request }) => {
  ...
  test.fixme("static GET route handler serves fresh data after revalidation period", async ({
    request,
  }) => {
